        ...
        <div id="about" className='w-full bg-white py-16 px-4'>
            <div className='max-w-[1240px] mx-auto grid md:grid-cols-2'>
                ...
                <div className='flex flex-col justify-center'>
                    <p className='text-[black] font-bold'>third year cybersecurity student</p>
                    <h1 className='md:text-4xl sm:text-3xl text-2xl font-bold py-2'>continously learning</h1>
                    <p className=''>
                    ...
                    <a href="https://www.linkedin.com/in/ismaeel-aziz" target="_blank" rel="noreferrer"><button className='bg-[blanchedalmond] w-[200px] rounded-md font-medium my-6 mx-auto md:mx-0 py-3 text-black'>let's connect!</button></a>
                </div>
